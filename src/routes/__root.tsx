...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "theme-color", content: "#0b0f1d", media: "(prefers-color-scheme: dark)" },
      { name: "theme-color", content: "#f5f8ff", media: "(prefers-color-scheme: light)" },
      { name: "color-scheme", content: "dark light" },
      { name: "msapplication-TileColor", content: "#22E4FF" },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Space+Grotesk:wght@400;500;600;700&family=Sora:wght@400;600;700;800&family=Inter:wght@400;500;600&display=swap",
      },
    ],
  }),
